...
json_path = 'G:/sunyongzhe/deeplabv3-plus-pytorch-main/datasets/before/'
...
for filename in filenames:
    ...
    json_path1 = 'G:/sunyongzhe/deeplabv3-plus-pytorch-main/datasets/a/' + filename  # 修改json文件后保存的路径
